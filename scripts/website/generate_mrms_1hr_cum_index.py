...
# === CONFIG ===
source_base = "/home/obrienj/crocus-analysis/mrms/hourly-cumulative/"  # full directory with ALL plots
target_base = "/home/obrienj/public_html/CROCUS/mrms-1hr-qpe/"      # public directory near index.html
html_target = "./CROCUS/mrms-1hr-qpe/"
days_back = 3                          # files newer than this get copied
remove_days_back = 4
output_file = "/home/obrienj/public_html/mrms_qpe_1hr_index.html"
...
for root, dirs, files in os.walk(source_base):
    for fname in files:
        if not fname.startswith("mrms-hourly-cum-qpe"):
            continue
...
<body>
<h1>MRMS Cumulative 1Hr Quantitative Precipitation Estimate (QPE) with CROCUS Micronet Observations</h1>
"""
...
##html += f'<div class="folder-content" id="MRMS Cumulative 1Hr QPE - CROCUS">\n'
